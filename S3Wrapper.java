 ...
 * (/home/yupenglu/.aws/credentials) where the sample code will load the credentials from.
 * <p>
...
public class S3Wrapper {
	...
	public S3Wrapper(String bucketName) {
...
//                    .withPrefix("My"));
            ...
            for (S3ObjectSummary objectSummary : objectListing.getObjectSummaries()) {
                System.out.println(" - " + URLDecoder.decode(objectSummary.getKey(), "UTF-8") + "  " +
                                   "(size = " + objectSummary.getSize() + ")");
            }
            S3Object testObj = s3.getObject(bucketName, URLEncoder.encode("http://finance.yahoo.com/investing-news/", "UTF-8"));
            S3ObjectInputStream inputStream = testObj.getObjectContent();
...
//    private static String streamToString(S3ObjectInputStream inputStream) {
...
//    }
    ...
    private String streamToString(S3ObjectInputStream inputStream) {
    	InputStreamReader in = new InputStreamReader(inputStream);
    	StringBuffer buffer = new StringBuffer();
    	int c;
    	try {
